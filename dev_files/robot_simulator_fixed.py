...
2. 运行脚本: python robot_simulator_fixed.py
...
class RobotSimulator:
    def __init__(self, server_ip="localhost", robot_id=1):
    ...
    def login(self, username="root", password="test123456"):
        ...
        try:
            ...
            print(f"🌐 请求URL: {self.base_url}/token/")
            ...
            print("   💡 建议: 确保服务器正在运行")
            print("   💡 建议: 尝试使用 'localhost' 或 '127.0.0.1'")
            return False
